  ...
  def get_detail_sentence(self, CP):
    if not CP.notCar:
      ...
      if CP.openpilotLongitudinalControl or CP.experimentalLongitudinalAvailable:
        sentence_builder += f" Traffic light and stop sign control is also available in {exp_link}."
      else:
        sentence_builder += f" {exp_link}, with traffic light and stop sign control, is not currently available for this car, but may be added in a future software update."
